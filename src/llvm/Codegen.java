...
public class Codegen extends VisitorAdapter{
	...
	public String translate(Program p, Env env){	
		...
		//Antes de come�ar a emitir codigo, vamos declarar as variaveis do sistema e imprimir elas
...
public LlvmValue visit(ClassDeclSimple n){
	...
	for (util.List<VarDecl> c = n.varList; c != null; c = c.tail)
	{
		...
		//TODO: Implementar esta parte, provavelmente temos que falar que o tipo � intArray
